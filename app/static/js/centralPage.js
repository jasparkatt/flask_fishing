...
var lyrStreet; //style layer from mapbox
var ctlLayers;
var ctlBasemaps;
var ctlOverlays;
...
$(document).ready(function() {
    ...
    lyrStreet = L.mapbox.styleLayer('mapbox://styles/mapbox/streets-v11')  
    
    mymap = L.map('map', {
        center:[44.49016, -89.30744],
        zoom:12,
        zoomControl:false,
        attributionControl:false,
        layers: [lyrCreek,lyrLabels, lyrRelief]
    });

    mymap.addLayer(lyrStreet);
